          ...
          {isRegister ? (
            <>
              ...
              <input
                ...
                name="name"
              />
              <img src={avater.url || user} alt=""  className="user-pro-img" onClick={zoomImage} onDoubleClick={removeZoom}/>
              <label htmlFor="file">Upload Profile Pic</label>
              <input type="file" style={{ display: "none" }} id="file" onChange={makeProfilePic}/>
            </>
          ) : (
            ""
          )}
